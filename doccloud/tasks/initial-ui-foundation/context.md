...
**NOTE:** Styling needs significant improvements - current implementation is functional but lacks polish. QDS v2.0 glassmorphism needs refinement for production quality.
