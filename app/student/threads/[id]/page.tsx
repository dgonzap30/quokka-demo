...
import { useThread, useCreatePost, useCurrentUser } from "@/lib/api/hooks";
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-semibold">{thread.isAnonymous ? "Anonymous" : thread.author.name}</p>
